...
// PS4 controller's RightStick.
void ControllerInputMovement() {
	float y = Input.GetAxis("RightVertical");
	float x = Input.GetAxis("RightHorizontal");

	wantedYRotation -= y * mouseSensitvity;
	wantedCameraXRotation += x * mouseSensitvity;
